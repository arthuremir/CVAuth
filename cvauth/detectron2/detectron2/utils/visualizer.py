...
from cvauth.detectron2.detectron2.structures import BitMasks, Boxes, BoxMode, Keypoints, PolygonMasks, RotatedBoxes
...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions, draw_boxes=True):
        """
